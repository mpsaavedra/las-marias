...
public class ProductBrandList : IAsyncMiddleware<ProductBrandListPayload, bool>, IMiddlewarePlugin
{
    ...
    {
        Name = "ProductBrand List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns ProductBrand list ";
        ShortName = "ProductBrand List";
        Enable = true;
        Level = 0;
        Dependencies = new List<Dependency>();
        EventCode = EventCodes.ProductBrandList;
    }
