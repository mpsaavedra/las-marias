...
public class CountryCreate :
    IAsyncMiddleware<CountryCreateInputModel, Domain.Models.Country>, IMiddlewarePlugin
{
    ...
    {
        Name = "Country Create Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "Creates new Country";
        ShortName = "Country creation";
        Enable = true;
        Level = 0;
    ...
    )
    {
        try
        {
            ...
            Domain.Models.Country entity = await next(input);

            if (entity == null)
            {
                var data = _repository.Mapper.Map<Domain.Models.Country>(input);
