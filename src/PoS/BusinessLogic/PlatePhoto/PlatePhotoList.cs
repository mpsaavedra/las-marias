namespace LasMarias.PoS.BusinessLogic.PlatePhoto;
...
public class PlatePhotoList : IAsyncMiddleware<PlatePhotoListPayload, bool>, IMiddlewarePlugin
{
    ...
    {
        Name = "PoS PlatePhoto List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns list with all available PlatePhotos";
        ShortName = "PoS PlatePhoto List";
        Enable = true;
        Level = 0;
