namespace LasMarias.PoS.BusinessLogic.Stand;
...
public class StandList : IAsyncMiddleware<StandListPayload, bool>, IMiddlewarePlugin
{
    ...
    public StandList()
    {
        Name = "PoS Stand List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns list with all available Stands";
        ShortName = "PoS Stand List";
        Enable = true;
        Level = 0;
