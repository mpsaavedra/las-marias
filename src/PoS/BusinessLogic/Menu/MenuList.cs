namespace LasMarias.PoS.BusinessLogic.Menu;
...
public class MenuList : IAsyncMiddleware<MenuListPayload, bool>, IMiddlewarePlugin
{
    ...
    public MenuList()
    {
        Name = "PoS Menu List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns list with all available Menus";
        ShortName = "PoS Menu List";
        Enable = true;
        Level = 0;
