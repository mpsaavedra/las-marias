namespace LasMarias.PoS.BusinessLogic.PlateCategory;
...
public class PlateCategoryList : IAsyncMiddleware<PlateCategoryListPayload, bool>, IMiddlewarePlugin
{
    ...
    {
        Name = "PoS PlateCategory List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns list with all available PlateCategorys";
        ShortName = "PoS PlateCategory List";
        Enable = true;
        Level = 0;
