namespace LasMarias.PoS.BusinessLogic.Seat;
...
public class SeatList : IAsyncMiddleware<SeatListPayload, bool>, IMiddlewarePlugin
{
    ...
    public SeatList()
    {
        Name = "PoS Seat List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns list with all available Seats";
        ShortName = "PoS Seat List";
        Enable = true;
        Level = 0;
