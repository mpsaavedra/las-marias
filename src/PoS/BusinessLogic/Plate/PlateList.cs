namespace LasMarias.PoS.BusinessLogic.Plate;
...
public class PlateList : IAsyncMiddleware<PlateListPayload, bool>, IMiddlewarePlugin
{
    ...
    public PlateList()
    {
        Name = "Profle Plate List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations LLC";
        Description = "returns list with all available Plates";
        ShortName = "Profile Plate List";
        Enable = true;
        Level = 0;
