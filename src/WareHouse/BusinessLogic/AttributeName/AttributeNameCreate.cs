    ...
    IAsyncMiddleware<AttributeNameCreateInputModel, Domain.Models.AttributeName>, IMiddlewarePlugin
{
    ...
    {
        Name = "WareHouse AttributeName Create Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "returns a new created attributeName";
        ShortName = "WareHouse AttributeName Create";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "attribute-name-create";
    }
    ...
    public async Task<Domain.Models.AttributeName> Run(AttributeNameCreateInputModel parameter, 
        Func<AttributeNameCreateInputModel, Task<Domain.Models.AttributeName>> next)
    {
        try
        {
            ...
            {    
                ...
                var mappedEntity = _repository.Mapper.Map<AttributeName>(parameter);
