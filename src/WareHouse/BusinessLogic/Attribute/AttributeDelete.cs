...
public class AttributeDelete : 
    IAsyncMiddleware<AttributeDeleteInputModel, bool>, IMiddlewarePlugin
{
    ...
    {
        Name = "WareHouse Attribute Delete Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "deletes an existing Attribute";
        ShortName = "WareHouse Attribute Delete";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "attribute-delete";
    }
    ...
    public async Task<bool> Run(AttributeDeleteInputModel parameter, 
        Func<AttributeDeleteInputModel, Task<bool>> next)
    {
        try
        {
            var result = true;
