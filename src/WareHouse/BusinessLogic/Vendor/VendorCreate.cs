    ...
    IAsyncMiddleware<VendorCreateInputModel, Domain.Models.Vendor>, IMiddlewarePlugin
{
    ...
    public VendorCreate()
    {
        Name = "WareHouse Vendor Create Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "returns a new created Vendor";
        ShortName = "WareHouse Vendor Create";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "vendor-create";
    }
    ...
    public async Task<Domain.Models.Vendor> Run(VendorCreateInputModel parameter, 
        Func<VendorCreateInputModel, Task<Domain.Models.Vendor>> next)
    {
        try
        {
            ...
            {    
                ...
                var mappedEntity = _repository.Mapper.Map<Vendor>(parameter);
