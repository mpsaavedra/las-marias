...
public class MeasureUnitList : IAsyncMiddleware<MeasureUnitListPayload, bool>, IMiddlewarePlugin
{
    ...
    {
        Name = "WareHouse Product MeasureUnit List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "returns a valid list with all available plugins MeasureUnits";
        ShortName = "WareHouse Product MeasureUnit List";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "get-measure-unit-list";
    }
