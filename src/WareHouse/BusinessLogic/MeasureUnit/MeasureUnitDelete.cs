...
public class MeasureUnitDelete : 
    IAsyncMiddleware<MeasureUnitDeleteInputModel, bool>, IMiddlewarePlugin
{
    ...
    public MeasureUnitDelete()
    {
        Name = "WareHouse MeasureUnit Delete Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "deletes an existing MeasureUnit";
        ShortName = "WareHouse MeasureUnit Delete";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "measure-unit-delete";
    }
    ...
    public async Task<bool> Run(MeasureUnitDeleteInputModel parameter, 
        Func<MeasureUnitDeleteInputModel, Task<bool>> next)
    {
        try
        {
            var result = true;
