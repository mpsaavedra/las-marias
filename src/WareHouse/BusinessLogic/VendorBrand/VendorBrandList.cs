#nullable enable
namespace LasMarias.WareHouse.BusinessLogic.VendorBrand;
...
public class VendorBrandList : IAsyncMiddleware<VendorBrandListPayload, bool>, IMiddlewarePlugin
{
    ...
    public VendorBrandList()
    {
        Name = "WareHouse Product VendorBrand List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "returns a valid list with all available plugins VendorBrands";
        ShortName = "WareHouse Product Vendor Brand List";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "get-vendor-brand-list";
    }
    ...
    public async Task<bool> Run(VendorBrandListPayload parameter, Func<VendorBrandListPayload, Task<bool>> next)
    {
        try
        {
