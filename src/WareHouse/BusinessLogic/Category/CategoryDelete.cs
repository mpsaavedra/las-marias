...
public class CategoryDelete : 
    IAsyncMiddleware<CategoryDeleteInputModel, bool>, IMiddlewarePlugin
{
    ...
    {
        Name = "WareHouse Category Delete Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "deletes an existing Category";
        ShortName = "WareHouse Category Delete";
        Enable = true;
        Level = 0; // this MUST be the first plugn to execute
        Dependencies = new List<Dependency>();
        EventCode = "category-delete";
    }
    ...
    public async Task<bool> Run(CategoryDeleteInputModel parameter, 
        Func<CategoryDeleteInputModel, Task<bool>> next)
    {
        try
        {
            var result = true;
