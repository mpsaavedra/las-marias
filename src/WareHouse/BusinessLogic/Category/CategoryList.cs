...
public class CategoryList : IAsyncMiddleware<CategoryListPayload, bool>, IMiddlewarePlugin
{
    ...
    public CategoryList()
    {
        Name = "WareHouse Product Category List Business Logic plugin";
        Version = "0.0.1";
        PluginId = Guid.NewGuid();
        Author = "Orun Innovations";
        Description = "returns a valid list with all available plugins Categorys";
        ShortName = "WareHouse Product Category List";
        Enable = true;
