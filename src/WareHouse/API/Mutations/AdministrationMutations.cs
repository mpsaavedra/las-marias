...
// {
//     public async Task<Domain.Models.ProductMovement> AdminCreateProductMovement(AttributeCreateInputModel input,
//         [Service] IChainOfResponsibilityService chain)
//     {
//         try
//         {
//             Log.Debug("Creating a new attribute");
//             var data = await chain.ExecuteAsyncChain<AttributeCreateInputModel, Domain.Models.ProductMovement>(
//                 "admin-create-product-movement", input
//             );
